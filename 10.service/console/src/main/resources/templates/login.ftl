...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/console/static/layui/layui/css/layui.css" media="all">
    <link rel="stylesheet" href="${request.contextPath}/console/static/layui/style/admin.css" media="all">
    <link rel="stylesheet" href="${request.contextPath}/console/static/layui/style/login.css" media="all">
    <title>登入 - 后台</title>
