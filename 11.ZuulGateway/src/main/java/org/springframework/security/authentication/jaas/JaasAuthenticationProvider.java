 ...
 * {@link Resource} instance. It should point to a JAAS
 * configuration file containing an index matching the
 * {@link #setLoginContextName(String) loginContextName} property.
 * </p>
 * <p>
 ...
 * through the
 * {@link #setCallbackHandlers(JaasAuthenticationCallbackHandler[])
